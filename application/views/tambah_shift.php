    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tambah Shift</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <div class="col-lg-6">
                        <?= form_open('tambah', ['class' => 'form-horizontal', 'id' => 'formContoh']) ?>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Nama Shift</label>
                            <div class="col-sm-6">
                                <input type="text" id="nama_shift" class="form-control" name="nama_shift" placeholder="Nama Shift" value="<?= set_value('nama_shift') ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Masuk</label>
                            <div class="col-sm-6">
                                <input type="text" id="datepicker" class="form-control" name="jam_masuk" placeholder="hh:mm" value="<?= set_value('jam_masuk') ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Pulang</label>
                            <div class="col-sm-6">
                                <input type="text" id="datepicker2" class="form-control" name="jam_keluar" placeholder="hh:mm" value="<?= set_value('jam_keluar') ?>">
                            </div>
                        </div>
...
<!--        <script type="text/javascript" src="<?php echo base_url(); ?>assets/j/jquery-3.0.0.min.js"></script>-->
